...
const Hero = ({ onOpenPopup }) => {
  ...
  return (
    <section id="hero" className="relative z-30 pt-0 sm:pt-10 pb-7 sm:pb-20">
      <div className="mx-auto lg:flex max-w-7xl px-5 pt-12 sm:px-12 md:gap-6 md:px-16 lg:px-20 lg:pt-6 xl:px-10 2xl:px-0">
        ...
        <div className="self-center lg:w-3/5">
          ...
          <h1 className="text-3xl font-bold text-gray-800 sm:text-5xl md:text-3xl mt-[15px] mb-[15px]">
            <span>New Senior Housing That's Perfect For You</span>
          </h1>
          ...
          <div className=" mt-5 sm:mt-10">
            ...
            <div className="mt-8 lg:w-4/5 grid grid-cols-3 gap-2 sm:gap-4 sm:space-y-0 relative lg:-ml-5">
              ...
              <div className="flex flex-col items-center col-span-1">
                ...
                />
                <span className="text-center mt-2 text-xs sm:text-sm">
                  by <b>Global Real Estate Brand Awards 2025</b>
                </span>
              </div>
            </div>
          </div>
        ...
        {/* Hero Image */}
        <div className="relative lg:w-2/5 mt-14 rounded-xl object-top sm:h-96 md:h-auto lg:mt-0">
          <img
            src="/images/image-9.webp"
            alt="hero image"
            width={470}
            height={627}
            className="hidden w-full rounded-xl object-cover sm:hidden md:block lg:block xl:block 2xl:block"
          />
          <img
            src="/images/image-9.webp"
            alt="hero image"
            width={280}
            height={320}
            className="block w-full rounded-xl object-cover sm:block sm:h-96 md:hidden lg:hidden xl:hidden 2xl:hidden"
          />
        </div>
      </div>
    </section>
