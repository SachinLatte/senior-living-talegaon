...
const whyChooseUsData = [
  ...
  },
  {
    ...
    description:
      "Foster friendships through clubs and enriching social activities.",
  },
  {
    num: 3,
    title: "Reliable Healthcare",
    description:
      "Access to on-site healthcare ensures immediate support when needed.",
  },
  {
    num: 4,
    title: "Daily Convenience",
    description:
      "Comprehensive daily assistance allows for a worry-free lifestyle.",
  },
  {
    num: 5,
  ...
  },
  {
    ...
    description:
      "Wellness amenities support physical, mental, and emotional well-being.",
  },
];

const WhyChooseUs = () => {
  return (
    <section id="whyus" className=" py-5 sm:py-16 lg:py-24">
      <div className="mx-auto max-w-7xl px-6">
        <div>
          <div className="grid-cols-2 items-center gap-x-16 lg:grid">
              ...
              <div className="gap-5 sm:grid sm:grid-cols-2">
                <div className="relative">
                  <LazyImage
                    ...
                    className=" w-full rounded-xl border object-cover object-left sm:mt-24 sm:h-96"
                  />
                </div>
            ...
            {/* Right side: Content */}
            <div className="mt-9 sm:mt-14 flex-col justify-center sm:mt-14 lg:mt-0 lg:flex">
              <div className="col-span-12 self-center lg:col-span-5 lg:col-start-8">
                ...
                <div className="grid justify-start">
                  {whyChooseUsData.map((item, index) => (
                    <div key={item.num} className="flex justify-between">
                      ...
                      <div
                        className={`w-full pt-1 ${index < whyChooseUsData.length - 1 ? "pb-6" : ""}`}
                      >
