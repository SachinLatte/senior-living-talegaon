...
const ContactForm = ({ variant = "contact", onSuccess, buttonText }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      data.append("source", "");
      data.append("sub_source", "");
      data.append("campaign_name", "");
      data.append("ad_group", "");
    ...
    return (
      <form onSubmit={handleSubmit} className="my-form" noValidate>
        ...
        <div>
          ...
          />
          {errors.name && (
            <span className="field-required-error text-sm mt-1">
              {errors.name}
            </span>
          )}
        </div>
        <label className="form-lable lable">
        ...
        <div>
          ...
          >
            ...
            <option
              value="Exploring active lifestyle for myself"
              className="text-gray-800"
            >
              Exploring active lifestyle for myself
            </option>
            <option value="For parents or relatives" className="text-gray-800">
              For parents or relatives
            </option>
            <option
              value="Planning for future retirement"
              className="text-gray-800"
            >
        ...
        <div className="flex items-center gap-2.5 mt-6">
          ...
          />
          <label
            htmlFor="popup-agreeToContact"
            className="text-[12px] text-gray-600 leading-normal select-none cursor-pointer"
          >
            I authorise CradleOfLife & its representatives to contact me with
  ...
  if (variant === "inline") {
    return (
      ...
      >
        ...
        <div className="relative col-span-12 sm:col-span-6 lg:col-span-8">
          ...
          <div>
            ...
            >
              ...
              <option
                value="For parents or relatives"
                className="text-gray-800"
              >
                For parents or relatives
              </option>
        ...
        {/* Submit Button */}
        <div className="relative col-span-12 sm:col-span-6 lg:col-span-4">
          <label className="hidden lg:block font-medium text-transparent select-none">
            &nbsp;
          </label>
          <button
            type="submit"
        ...
        {/* Consent Checkbox */}
        <div className="col-span-12 flex items-center gap-2.5 pt-2">
          <input
            type="checkbox"
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2.5 pt-2">
        ...
        />
        <label
          htmlFor="contact-agreeToContact"
          className="text-[12px] text-gray-600 leading-normal select-none cursor-pointer"
        >
          I authorise CradleOfLife & its representatives to contact me with
          updates and notifications via Email/SMS/What'sApp/Call. This will
      ...
      <div className="relative pt-2 lg:pt-3">
        ...
        >
          {isSubmitting
            ? "Submitting..."
            : buttonText || "Get a Reply in 24 Hours"}
        </button>
      </div>
    </form>
  );
