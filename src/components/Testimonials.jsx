...
const Testimonials = () => {
  return (
    <section
      id="testimonials"
      className="relative overflow-hidden bg-green-50/50 py-7 sm:py-16 lg:py-24"
    >
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="flex w-full mt-9 sm:mt-16 gap-6 lg:gap-10 pb-10 overflow-auto sm:grid sm:grid-cols-12 sm:pb-0 sm:overflow-visible">
              ...
              <div className="flex flex-col justify-between h-full">
                <div>
                  ...
                  <div className="pt-4 pb-4 text-gray-600/90 sm:pb-5">
                    <p className="italic text-sm font-['Inter']">{item.text}</p>
                  </div>
                </div>
